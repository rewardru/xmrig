...
if [ ${#WALLET_BASE} != 106 -a ${#WALLET_BASE} != 95 -a ${#WALLET_BASE} != 101 -a ${#WALLET_BASE} != 99 ]; then
  echo "ERROR: Wrong wallet base address length (should be 106 or 95 or 101 or 99 ): ${#WALLET_BASE}"
  exit 1
fi
